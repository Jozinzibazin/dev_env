...
urlpatterns = [
    ...
    path('cart_change/<int:product_id>/', views.cart_change, name='cart_change'),  # URL '' будет соответствовать представлению catalog из файла views
    path('cart_remove/<int:product_id>/', views.cart_remove, name='cart_remove'), #URL 'product/' будет соответствовать представлению product из файла views
]