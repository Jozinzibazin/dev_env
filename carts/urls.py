...
urlpatterns = [
    ...
    path('cart_change/', views.cart_change, name='cart_change'),  # URL '' будет соответствовать представлению catalog из файла views
    path('cart_remove/', views.cart_remove, name='cart_remove'), #URL 'product/' будет соответствовать представлению product из файла views
]